...
const About = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 px-8 md:px-16 py-12 md:py-20 text-base-content bg-">
      <div className="relative h-70 md:h-auto">
        ...
        />
        <div className="z-50 absolute hidden md:block lg:block bottom-6 left-6 bg-base-100 rounded px-10 py-5">
